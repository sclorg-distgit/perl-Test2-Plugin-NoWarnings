%{?scl:%scl_package perl-Test2-Plugin-NoWarnings}

Name:		%{?scl_prefix}perl-Test2-Plugin-NoWarnings
Version:	0.08
Release:	2%{?dist}
...
BuildRequires:	%{?scl_prefix}perl(Test2) >= 1.302096
...
%changelog
* Mon Jan 06 2020 Jitka Plesnikova <jplesnik@redhat.com> - 0.08-2
- SCL
